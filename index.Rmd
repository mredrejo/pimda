...
Data is shared under creative common license (CC BY-NC 3.0 ES). Contact [modesto.redrejo\@uam.es](mailto:modesto.redrejo@uam.es) for further info.
...
quast_ref_melted$Category <- factor(quast_ref_melted$Category, levels = c("B. subtilis", "E. coli","K. rhizophila","P. aeruginosa","Not_aligned"))
...
quast_ref_mism <- read.table("quast_results/num_mismatches_per_100_kbp.tsv",header=TRUE, na.strings = "", sep="\t",strip.white = TRUE)
...
quast_ref_mism_melted$ind <- factor(quast_ref_mism_melted$ind, levels = c("NA",
    "RP-MDA", "PrimPol-MDA", "piPolB+D", "piMDA", "piMDA+D"))
quast_ref_mism_melted$Category <- factor(quast_ref_mism_melted$Category, levels = c("B. subtilis", "E. coli","K. rhizophila","P. aeruginosa","Not_aligned"))
